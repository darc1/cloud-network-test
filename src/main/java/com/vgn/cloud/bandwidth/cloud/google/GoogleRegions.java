...
public class GoogleRegions {
    ...
    public static final String US_WEST1_A = "us-west1-a";
    public static final String US_WEST1_B = "us-west1-b";
    ...
    public static final String ASIA_NORTHEAST1_A = "asia-northeast1-a";
    public static final String ASIA_NORTHEAST1_B = "asia-northeast1-b";
    public static final String ASIA_NORTHEAST1_C = "asia-northeast1-c";
